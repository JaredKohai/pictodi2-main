...
/// The [GeneradorIA] widget is the root widget of the app
class GeneradorIA extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Test(title: 'Generador de Picotagramas con IA'),
    );
  }
}
...
class _TestState extends State<Test> {
  ...
  final String apiKey = 'sk-YMJeU2D8HNLQwfYBCLMN9uSx9wZBGw0HIv029D89qRsAZMcK';
